...
from app_catalog.serializers import CategorySerializer, TagsSerializer, BannersSerializer
from app_products.models import Tag, Product
...
class BannersView(APIView):
    """ Отображение баннеров главной страницы"""
    def get(self, request):
        categories = []
